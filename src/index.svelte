<script>
  import { getJsFuncs } from "./_includes/SvelteContext.svelte";
  import PortfolioLayout from "./_includes/PortfolioLayout.svelte";
  export let profile;
  export let feeds;
  export let page;
  const { isodate, svginline } = getJsFuncs();
</script>
...
<PortfolioLayout pageUrl={page.url}>
  ...
  <section class="simple-card">
    <h2 class="heading" id="education">
      <a href="#education" class="anchor"> Education </a>
    </h2>
  ...
  <section class="simple-card">
    <h2 class="heading" id="intern">
      <a href="#intern" class="anchor"> Internships / Employments </a>
    </h2>
  ...
  <section class="simple-card">
    <h2 class="heading" id="publications">
      <a href="#publications" class="anchor"> Publications </a>
    </h2>
  ...
  <section class="simple-card">
    <h2 class="heading" id="posts">
      <a href="#posts" class="anchor"> Posts </a>
    </h2>
    {#each feeds as post}
  ...
  <section class="simple-card">
    <h2 class="heading" id="presentations">
      <a href="#presentations" class="anchor"> Presentations </a>
    </h2>
    <div class="content">
      <ul class="_reset-ul slide-list">
        {#each profile.slides as s}
          <li class="slide-item">
  ...
  <section class="simple-card">
    <h2 class="heading" id="works">
      <a href="#works" class="anchor"> Works </a>
    </h2>
    <div class="content">
      <div class="works-gallery">
        {#each profile.works.slice(0, 2) as w}
